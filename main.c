...
/**
 * start_vglo - initializes the global variable within the program
 *
 * @fd: file decriptor
 * Return: no return
 */
...
/**
 * check_input - this checks if a file exist and can be opened
 * @argc: this is the argument count within the program
